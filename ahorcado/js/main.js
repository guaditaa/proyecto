...
var fallar = new Audio('./ahorcado/media/perder.mp3');
var acertar = new Audio('./ahorcado//media/acertar.mp3');
var fondo = new Audio('./ahorcado/media/fondo.mp3');
...
function comprobarTecla(letraUsuario) {
  ...
  if (!palabraAdivinar.includes(letraUsuario)) {
    ...
    if (numIntentos == 5) {
      document.getElementById('imagen').src = '/ahorcado/img/svg/cabeza.svg';
    } else if (numIntentos == 4) {
      document.getElementById('imagen').src = '/ahorcado/img/svg/cuerpo.svg';
    } else if (numIntentos == 3) {
      document.getElementById('imagen').src = '/ahorcado/img/svg/brazoIzq.svg';
    } else if (numIntentos == 2) {
      document.getElementById('imagen').src = '/ahorcado/img/svg/brazoDer.svg';
    } else if (numIntentos == 1) {
      document.getElementById('imagen').src = '/ahorcado/img/svg/piernaIzq.svg';
    } else if (numIntentos == 0) {
      document.getElementById('imagen').src = '/ahorcado/img/svg/piernaDer.svg';
    }
...
function estadoPartida() {
  ...
  if (!palabraMostrar.includes('_')) {
    ...
    document.getElementById('imagen').src = '/ahorcado/img/svg/victoria.svg';
...
function reiniciarPartida() {
  ...
  nodoBotonReiniciar.textContent = "Siguiente";
  document.getElementById('imagen').src = '/ahorcado/img/svg/horca.svg';
...
function controlMusicaFondo() {
  ...
  if (!fondo.paused) {
    ...
    nodoAltavoz.src = '/ahorcado/img/altavozOff.png';
    // Si no está parada
  } else {
    ...
    // Cambiamos la imagen del altavoz
    nodoAltavoz.src = '/ahorcado/img/altavozOn.png';
  }
}
...
window.onload = function() {
  ...
  document.addEventListener('keypress', cogerTecladoFisico);
}
